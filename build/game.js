...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(63), __webpack_require__(328)))
...
var _timer = __webpack_require__(330);
...
Promise.all([loadSprite('./img/image.png')]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 1),
      img = _ref2[0];

  var timer = new _timer2.default(1 / 60);

  timer.draw = function () {

    ctx.clearRect(0, 0, 612, 612);

    ctx.drawImage(img, 0, 0, img.width, img.height, iX, iY, img.width, img.height);
  };
